...
type SmoothInputType = "text" | "password" | "email" | "number" | "tel" | "url";
...
const Skiper106Input = React.forwardRef<
  HTMLInputElement,
  SmoothInputProps & {
    label?: string;
...
>(({ label, icon, error, containerClassName, wrapperClassName, className, ...props }, ref) => {
  return (
...
export { Input, Skiper106, SmoothInput, Skiper106Input };
